...
const comms = [
  {
    user: "Teodor Nikola",
    comment:
      "This is a very good product. Delivery time was excellent. Very good quality!!! (Y)",
  ...
  },
  {
    user: "Naum Anteski",
    comment:
      "I got the same product on amazon. Looking forward for a mobile site. Keep up the good work",
    image: placeholederImage,
    date: "01/21/2021, 11:52:13 AM",
  },
  {
